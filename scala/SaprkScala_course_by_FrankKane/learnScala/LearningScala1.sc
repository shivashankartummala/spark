object LearningScala1 {
  ...
  val hello: String = "Hola! welcome to scala!"   //> hello  : String = Hola! welcome to scala!
  println(hello)                                  //> Hola! welcome to scala!
  
  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.
  
  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = Hola! welcome to scala!
  helloThere = hello + " There!"
  println(helloThere)                             //> Hola! welcome to scala! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Hola! welcome to scala!There!
  println(immutableHelloThere)                    //> Hola! welcome to scala!There!
  ...
  val a = 3.1415f                                 //> a  : Float = 3.1415
  val b = a*2                                     //> b  : Float = 6.283
  println(f"the result is $b%.3f")                //> the result is 6.283
