...
object LogSQLToJson {
  ...
  def main(args: Array[String]) {
    ...
    requests.foreachRDD((rdd, time) => {
      ...
      val requestsDataFrame = rdd.map(w => Record1(w._1, w._2, w._3)).toDF()
      ...
      println(s"========= $time =========")
      wordCountsDataFrame.write.json("../SparkScala_Data/output/logsql_")
...
case class Record1(url: String, status: Int, agent: String)
